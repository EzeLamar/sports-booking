...
import ReservationModal from '@/app/(my-app)/components/Reservations/ReservationModal';
import {
	EventProp,
	SelectEventSlotProp,
	TEvent,
} from '@/app/(my-app)/components/UI/Calendar/model';
import { ReservationStatus } from '@/app/(my-app)/firebase/reservations/model';
